...
public class OperationLogsAspect {
    ...
    @Pointcut("execution(* com.cristik.business.service.*Service.*insert*(..))")
    public void insertServiceCall(){
    }

    @Pointcut("execution(* com.cristik.business.service.*Service.*delete*(..))")
    public void deleteServiceCall(){
    }

    @Pointcut("execution(* com.cristik.business.service.*Service.*update*(..))")
    ...
    public void updateServiceCallAround()throws Throwable{
        System.out.println("aop-update-around");
    }*/
